...
const Navbar = () => {
    ...
    return (
        <nav className={`text-[#030712] font-bold h-[80px] ${sticky? 'bg-[#3f3f46]':'bg-transparent'}  transition-[0.5s] bg-transparent fixed font-outfit py-4 px-0 w-full top-0 left-0 flex items-center justify-between z-10 m-0`}>
